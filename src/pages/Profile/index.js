              ...
              <div>
                ...
                <div className="my-4 flex items-center justify-between px-4">
                  <button
                    ...
                    type="button"
                    className="text-white flex items-center justify-between bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2"
                  >
                    <svg
